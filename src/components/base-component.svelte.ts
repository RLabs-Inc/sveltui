...
export interface ComponentProps extends TerminalLayoutProps {
  // Interaction
  focusable?: boolean
  tabIndex?: number
...
export class BaseComponent {
  ...
  constructor(type: number, props: ComponentProps, canHaveChildren = false) {
