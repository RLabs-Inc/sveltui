// ============================================================================
// SVELTUI - SIMPLIFIED YOGA PROPS
// Essential layout properties for terminal UIs only
// ============================================================================
...
export interface TerminalLayoutProps {
  ...
  // Spacing (simplified - just support uniform or axis-based)
  margin?: number
  marginX?: number
  marginY?: number
  padding?: number
  ...
  // Position (minimal support)
  position?: 'relative' | 'absolute'
  top?: number
  left?: number
  
  // Border (for layout calculation only)
  borderWidth?: number
...
// Apply props to yoga node - much simpler!
export function applyTerminalProps(
  node: any,
  props: TerminalLayoutProps,
  Yoga: any
) {
  // Display
  if (props.display !== undefined) {
    node.setDisplay(
      props.display === 'none' ? Yoga.DISPLAY_NONE : Yoga.DISPLAY_FLEX
    )
  }
  ...
  if (props.flexWrap !== undefined) {
    node.setFlexWrap(
      props.flexWrap === 'wrap' ? Yoga.WRAP_WRAP : Yoga.WRAP_NO_WRAP
    )
  }
  ...
  // Spacing - simplified to just support uniform or axis-based
