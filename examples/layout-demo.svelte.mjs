...
Layout_demo[$.FILENAME] = 'layout-demo.svelte';

import * as $ from 'svelte/internal/client';
import Box from '../src/components/ui/Box.svelte.mjs';
import Text from '../src/components/ui/Text.svelte.mjs';

var root_1 = $.add_locations($.template(`<!> <!> <!> <!> <!> <!> <!> <!> <!>`, 1), Layout_demo[$.FILENAME], []);

export default function Layout_demo($$anchor, $$props) {
	$.check_target(new.target);
	$.push($$props, true, Layout_demo);
	...
	Box($$anchor, {
		...
		height: '100%',
		style: { bg: '#111' },
		children: $.wrap_snippet(Layout_demo, ($$anchor, $$slotProps) => {
