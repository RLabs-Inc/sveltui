...
Interactive_list[$.FILENAME] = 'interactive-list.svelte';
...
var root_4 = $.add_locations($.template(`<!> <!>`, 1), Interactive_list[$.FILENAME], []);
var root_3 = $.add_locations($.template(`<!> <!>`, 1), Interactive_list[$.FILENAME], []);
var root_1 = $.add_locations($.template(`<!> <!> <!> <!>`, 1), Interactive_list[$.FILENAME], []);

export default function Interactive_list($$anchor, $$props) {
	$.check_target(new.target);
	$.push($$props, true, Interactive_list);
	...
	Box($$anchor, {
		...
		children: $.wrap_snippet(Interactive_list, ($$anchor, $$slotProps) => {
