...
Style_states[$.FILENAME] = 'style-states.svelte';
...
export default function Style_states($$anchor, $$props) {
	$.check_target(new.target);
	$.push($$props, true, Style_states);
	...
	text_2.__mouseover = function (...$$args) {
		$.apply(() => $.get(event_handler_14), this, $$args, Style_states, [152, 19], true);
	};

	var event_handler_15 = $.derived(() => handleMouseOut(textStyle));

	text_2.__mouseout = function (...$$args) {
		$.apply(() => $.get(event_handler_15), this, $$args, Style_states, [153, 18], true);
	};
	...
	$.event('focus', box, function (...$$args) {
		$.apply(() => $.get(event_handler), this, $$args, Style_states, [86, 11], true);
	});

	$.event('blur', box, function (...$$args) {
		$.apply(() => $.get(event_handler_1), this, $$args, Style_states, [87, 10], true);
	});

	$.event('focus', button, function (...$$args) {
		$.apply(() => $.get(event_handler_6), this, $$args, Style_states, [112, 15], true);
	});

	$.event('blur', button, function (...$$args) {
		$.apply(() => $.get(event_handler_7), this, $$args, Style_states, [113, 14], true);
	});

	$.event('focus', button_1, function (...$$args) {
		$.apply(() => $.get(event_handler_12), this, $$args, Style_states, [130, 15], true);
	});

	$.event('blur', button_1, function (...$$args) {
		$.apply(() => $.get(event_handler_13), this, $$args, Style_states, [131, 14], true);
	});
